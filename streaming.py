...
PROJECT_ID = 'enduring-range-306216'
BQ_DATASET = 'uwgp_triage'
BQ_TABLE = 'insight_tag_data'
ERROR_TOPIC = 'projects/enduring-range-306216/topics/streaming_error_topic'
SUCCESS_TOPIC = 'projects/enduring-range-306216/topics/streaming_success_topic'
DB = firestore.Client()
CS = storage.Client()
...
def _insert_into_bigquery(bucket_name, file_name):
    dataset_ref = BQ.dataset('uwgp_triage')
    job_config = bigquery.LoadJobConfig(
        schema=[
            bigquery.SchemaField("FQN", "STRING"),
            bigquery.SchemaField("DateTime", "TIMESTAMP"),
            bigquery.SchemaField("OpcQuality", "INTEGER"),
    ...
    load_job = BQ.load_table_from_uri(
        uri,
        dataset_ref.table('insight_tag_data'),
